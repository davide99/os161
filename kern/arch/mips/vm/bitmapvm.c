...
static uint8_t *used_pages = NULL;
...
void vm_bootstrap(void)
{
	...
	used_pages = kmalloc(sizeof(*used_pages) * ram_frames);
	if (used_pages == NULL)
		return;
	...
	memset(used_pages, 0, sizeof(*used_pages) * ram_frames);
